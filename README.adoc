= Juice Shop's Antora UI project 

== Setup:
Clone the project and follow the prerequisites[https://docs.antora.org/antora-ui-default/prerequisites/] for this project.
After fulfilling the prerequisites, run the following command to preview the UI.

 $ gulp preview

To bundle the UI in order to preview the UI on the real site in local development, run the following command:
